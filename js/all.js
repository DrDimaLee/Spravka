...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Типы данных","1. ТИПЫ ДАННЫХ","1.1. Универсальные коллекции","1.2. Прикладные объекты (И)","1.3. Другие типы","1.4. Ссылка нового","1.1.1. Таблица значений","1.1.2. Список значений","1.1.3. Структура","1.1.4. Сооветстветствие","1.1.5. Массив","1.1.6. Дерево значений","1.2.1. Табличная часть объекта","1.2.2. Регистр","1.2.3. Константы","1.2.4. Справочники","1.2.5. Документы","1.2.6. Перечисления","1.2.7. Планы видов характеристик","1.2.8. Планы счетов","1.2.9. Планы видов расчета","1.2.10. Регистры сведений","1.2.11. Регистры накопления","1.2.12. Регистры бухгалтерии","1.2.13. Регистры расчета","1.2.14. Планы обмена","1.3.1. Хранилище значений","1.3.2. Хранилище настроек","1.1.1.1. Создать","1.1.1.2. Найти","1.1.1.3. НайтиСтроки","1.1.1.4. Скопировать (Выгрузить)","1.1.1.5. Скопировать с произвольным отбором","1.1.1.6. Загрузить ТЗ в другую ТЗ","1.1.1.7. Свернуть (сгруппировать)","1.1.1.8. Сортировать","1.1.1.9. Удалить","1.1.1.10. Копирование строк между таблицами значений (табличными частями и т.п.) произвольной структуры","1.1.1.11. Поячеечный обход таблицы значений","1.1.1.12. Выгрузить колонку","1.1.1.13. Загрузить колонку","1.1.1.14. ТЗ в массив структур","1.1.1.15. Проверка наличия колонки","1.1.1.16. ТЗ в структуру","1.1.1.17. Добавить колонку","1.1.1.18. ВыгрузкаПоТаблицеЗначений с отбором","1.1.1.19. ЗагрузитьВТаблицуЗначений","1.1.1.20. РазметитьПоКолонкам","1.1.2.1. Создать","1.1.2.2. Добавить","1.1.2.3. Вставить","1.1.2.4. ЗагрузитьЗначения","1.1.3.1. Структура vs Соответствие","1.1.3.2. Проверка наличия свойства","1.1.3.3. Ошибка «Задано неправильное имя атрибута структуры»","1.1.3.4. Создать","1.1.5.1. Дополнить массив уникальными значениями","1.1.5.2. ДополнитьСписокИлиМассивЗначениями","1.2.1.1. Выгрузить строки с отбором","1.2.1.2. Выгрузить колонку","1.2.1.3. Удалить строки","1.2.1.4. Автоматическое заполнение полей при вводе новой строки табличного поля","1.2.1.5. Как рассчитать сумму  в строке табличной части справочника или документа?","1.2.2.1. Добавить","1.2.2.2. Проверка Запись","1.2.2.3. Очистка регистра","1.2.2.4. Программное удаление записей регистра сведений","1.2.2.5. Подчиненный регистратору","1.2.3.1. Константы","1.2.3.2. Последовательность событий при записи констант из формы констант (записать и закрыть)","1.2.4.1. Объекты встроенного языка для работы со справочниками","1.2.4.2. Последовательность событий при записи элемента справочника из формы элемента (записать и закрыть)","1.2.4.3. Подчиненный справочник","1.2.4.4. Выбор только группы","1.2.4.5. Запись реквизита группы","1.2.4.6. Обработчики событий ОбработкаПолученияПредставления и ОбработкаПолученияПолейПредставления  ","1.2.5.1. Объекты встроенного языка для работы с документами","1.2.5.2. Последовательность событий при записи документа из формы документа","1.2.5.3. Последовательность событий при проведении документа из формы документа (провести и закрыть)","1.2.5.4. Последовательность событий при отмене проведения документа из формы документа","1.2.5.5. Связанные табличные части","1.2.6.1. Объекты встроенного языка для работы с перечислениями","1.2.7.1. Объекты встроенного языка для работы с планами видов характеристик","1.2.7.2. Последовательность событий при записи вида характеристики из формы элемента (записать и закрыть)","1.2.8.1. Объекты встроенного языка для работы с планами счетов","1.2.8.2. Последовательность событий при записи счета из формы счета (записать и закрыть)","1.2.9.1. Объекты встроенного языка для работы с планом видов расчета","1.2.9.2. Последовательность событий при записи вида расчета из формы вида расчета (записать и закрыть)","1.2.10.1. Объекты встроенного языка для работы с регистрами сведений","1.2.10.2. Последовательность событий при сохранении данных из формы записи регистра сведений (записать и закрыть)","1.2.10.3. Последовательность событий при сохранении данных из формы набора записей регистра сведений (записать и закрыть)","1.2.11.1. Объекты встроенного языка для работы с регистрами накопления","1.2.11.2. Последовательность событий при сохранении набора записей регистра накопления из формы набора записей","1.2.12.1. Объекты встроенного языка для работы с регистрами бухгалтерии","1.2.12.2. Последовательность событий при сохранении набора записей регистра бухгалтерии из формы","1.2.13.1. Объекты встроенного языка для работы с регистрами расчетов","1.2.13.2. Последовательность событий при сохранении набора записей регистра расчета из формы","1.2.14.1. Объекты встроенного языка для работы с планами обмена","1.2.14.2. Последовательность событий при записи узла плана обмена из формы узла (записать и закрыть)","1.1.1.6.1. Простой трюк для быстрого объединения таблиц значений"],
    DREX_NODE_LINKS: ["tipy_dannykh_1.html","tipy_dannykh_2.html","universalnye_kollektsii.html","prikladnye_obekty__i_.html","drugie_tipy.html","ssylka_novogo.html","tablitsa_znachenij.html","spisok_znachenij.html","struktura.html","soovetstvetstvie.html","massiv.html","derevo_znachenij.html","tablichnaya_chast_obekta.html","registr.html","konstanty_1.html","spravochniki.html","dokumenty.html","perechisleniya.html","plany_vidov_kharakteristik.html","plany_schetov.html","plany_vidov_rascheta.html","registry_svedenij.html","registry_nakopleniya.html","registry_bukhgalterii.html","registry_rascheta.html","plany_obmena.html","khranilishche_znachenij.html","khranilishche_nastroek.html","sozdat_1.html","najti.html","najtistroki.html","skopirovat__vygruzit_.html","skopirovat_s_proizvolnym_otborom.html","zagruzit_tz_v_druguyu_tz.html","svernut__sgruppirovat_.html","sortirovat.html","udalit.html","kopirovanie_strok_mezhdu_tablitsami_znachenij__tablichnymi_chastyami_i_t_p___proizvolnoj_struktury.html","poyacheechnyj_obkhod_tablitsy_znachenij.html","vygruzit_kolonku_1.html","zagruzit_kolonku.html","tz_v_massiv_struktur.html","proverka_nalichiya_kolonki.html","tz_v_strukturu.html","dobavit_kolonku.html","vygruzkapotablitseznachenij_s_otborom.html","zagruzitvtablitsuznachenij.html","razmetitpokolonkam.html","sozdat_2.html","dobavit_1.html","vstavit.html","zagruzitznacheniya.html","struktura_vs_sootvetstvie.html","proverka_nalichiya_svojstva.html","oshibka__zadano_nepravilnoe_imya_atributa_struktury_.html","sozdat_3.html","dopolnit_massiv_unikalnymi_znacheniyami.html","dopolnitspisokilimassivznacheniyami.html","vygruzit_stroki_s_otborom.html","vygruzit_kolonku_2.html","udalit_stroki.html","avtomaticheskoe_zapolnenie_polej_pri_vvode_novoj_stroki_tablichnogo_polya.html","kak_rasschitat_summu__v_stroke_tablichnoj_chasti_spravochnika_ili_dokumenta_.html","dobavit_2.html","proverka_zapis.html","ochistka_registra.html","programmnoe_udalenie_zapisej_registra_svedenij.html","podchinennyj_registratoru.html","konstanty_2.html","posledovatelnost_sobytij_pri_zapisi_konstant_iz_formy_konstant__zapisat_i_zakryt_.html","obekty_vstroennogo_yazyka_dlya_raboty_so_spravochnikami.html","posledovatelnost_sobytij_pri_zapisi_ehlementa_spravochnika_iz_formy_ehlementa__zapisat_i_zakryt_.html","podchinennyj_spravochnik.html","vybor_tolko_gruppy.html","zapis_rekvizita_gruppy.html","obrabotchiki_sobytij_obrabotkapolucheniyapredstavleniya_i_obrabotkapolucheniyapolejpredstavleniya___.html","obekty_vstroennogo_yazyka_dlya_raboty_s_dokumentami.html","posledovatelnost_sobytij_pri_zapisi_dokumenta_iz_formy_dokumenta.html","posledovatelnost_sobytij_pri_provedenii_dokumenta_iz_formy_dokumenta__provesti_i_zakryt_.html","posledovatelnost_sobytij_pri_otmene_provedeniya_dokumenta_iz_formy_dokumenta.html","svyazannye_tablichnye_chasti.html","obekty_vstroennogo_yazyka_dlya_raboty_s_perechisleniyami.html","obekty_vstroennogo_yazyka_dlya_raboty_s_planami_vidov_kharakteristik.html","posledovatelnost_sobytij_pri_zapisi_vida_kharakteristiki_iz_formy_ehlementa__zapisat_i_zakryt_.html","obekty_vstroennogo_yazyka_dlya_raboty_s_planami_schetov.html","posledovatelnost_sobytij_pri_zapisi_scheta_iz_formy_scheta__zapisat_i_zakryt_.html","obekty_vstroennogo_yazyka_dlya_raboty_s_planom_vidov_rascheta.html","posledovatelnost_sobytij_pri_zapisi_vida_rascheta_iz_formy_vida_rascheta__zapisat_i_zakryt_.html","obekty_vstroennogo_yazyka_dlya_raboty_s_registrami_svedenij.html","posledovatelnost_sobytij_pri_sokhranenii_dannykh_iz_formy_zapisi_registra_svedenij__zapisat_i_zakryt_.html","posledovatelnost_sobytij_pri_sokhranenii_dannykh_iz_formy_nabora_zapisej_registra_svedenij__zapisat_i_zakryt_.html","obekty_vstroennogo_yazyka_dlya_raboty_s_registrami_nakopleniya.html","posledovatelnost_sobytij_pri_sokhranenii_nabora_zapisej_registra_nakopleniya_iz_formy_nabora_zapisej.html","obekty_vstroennogo_yazyka_dlya_raboty_s_registrami_bukhgalterii.html","posledovatelnost_sobytij_pri_sokhranenii_nabora_zapisej_registra_bukhgalterii_iz_formy.html","obekty_vstroennogo_yazyka_dlya_raboty_s_registrami_raschetov.html","posledovatelnost_sobytij_pri_sokhranenii_nabora_zapisej_registra_rascheta_iz_formy.html","obekty_vstroennogo_yazyka_dlya_raboty_s_planami_obmena.html","posledovatelnost_sobytij_pri_zapisi_uzla_plana_obmena_iz_formy_uzla__zapisat_i_zakryt_.html","prostoj_tryuk_dlya_bystrogo_obedineniya_tablits_znachenij.html"],
    DREX_NODE_CHILD_START: [1,2,6,12,26,28,28,48,52,56,56,58,58,63,68,70,76,81,82,84,86,88,91,93,95,97,99,99,99,99,99,99,99,99,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100],
    DREX_NODE_CHILD_END: [2,6,12,26,28,28,48,52,56,56,58,58,63,68,70,76,81,82,84,86,88,91,93,95,97,99,99,99,99,99,99,99,99,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100],
    DREX_MENU_TYPE: 2,
